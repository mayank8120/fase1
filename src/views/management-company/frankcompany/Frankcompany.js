  ...
  render() {
    ...
    return (
      <main className="frankcompany">
        <CRow>
          <CCol md="12" className="font-weight700 font-size24 colorBlack pl-0">
            Frank Company
            <Breadcrumb>
          ...
          <Col lg="9" md="9" sm="12" xs="12">
            <Row>
              ...
              {/* main header */}
              <CCol lg="8" md="8" sm="12" xs="12" className="pl-0 mmb-24">
                <div className="statementBox bg-white brdrRadius8 height268">
                  <CRow>
                    <CCol sm="6" className="sdd">
              ...
              {/* Revenue column */}
              <CCol lg="4" md="4" sm="12" xs="12" className="pr-0 mpl-0 px-2">
            ...
            <Row className="mt-24">
              ...
              <CCol lg="4" md="4" sm="12" xs="12" className="pl-0 mmb-24">
                <div className="revenueBox bg-white  brdrRadius8 height268">
                  <div class="d-flex align-items-center mb-3">
                    <svg xmlns="http://www.w3.org/2000/svg" width="44" height="44" viewBox="0 0 44 44" fill="none">
                      <circle opacity="0.1" cx="22" cy="22" r="22" fill="#11A1FD" />
              ...
              <CCol lg="4" md="4" sm="12" xs="12" className="pl-0 mmb-24 mpl-0">
              ...
              {/* USERS column */}
              <CCol lg="4" md="4" sm="12" xs="12" className="pr-0 mpl-0 mmb-24 px-2">
                <div className="revenueBox bg-white  brdrRadius8 height268">
          ...
          <CCol lg="3" md="3" sm="12" xs="12" className="pr-0">
        ...
        <CRow className="bgwhite mt-24">
          <CCol lg="12" md="12" sm="12" xs="12" className="mt-24 pl-0 pr-0 ">
