            ...
            <div className="filterSection mt-24">
              <div className="filter-section d-flex align-items-center">
                ...
                <div className="ml-auto d-flex align-items-center btnsSec">
                  ...
                  <CButton onClick={this.onClickButton} variant="primary" className="mr-3 colorWhite gradientBtn font-size14 font-weight700 d-flex align-items-center">
                  ...
                  <CModal
                    ...
                    <CModalBody>
                      <div className="ticket-form">
                        ...
                        <CForm action="" method="post" encType="multipart/form-data" className="form-horizontal">
                          ...
                          <CFormGroup row>
                            <CCol md="2">
                              <CLabel htmlFor="select">Assign to</CLabel>
                            </CCol>
                            <CCol xs="12" md="10">
                          ...
                          <CFormGroup row>
                            <CCol md="2">
                              <CLabel htmlFor="text-input">CC Users</CLabel>
                            </CCol>
                            <CCol xs="12" md="10">
                              <CInput id="text-input" name="text-input" placeholder="Enter CC Users" />
                          ...
                          <CFormGroup row>
                            ...
                            <CCol xs="12" md="10">
                              <CInput id="text-input" name="text-input" placeholder=" Due Date" />

                            </CCol>
                          </CFormGroup>
                          <CFormGroup row>
                            <CCol md="2">
                              <CLabel htmlFor="text-input">Due Time
                              </CLabel>
                            </CCol>
                            <CCol xs="12" md="10">
                              <CInput id="text-input" name="text-input" placeholder="5:00 PM. 18:00. etc" />
                    ...
                    {/* <CModalFooter>
                      ...
                      <CButton color="secondary" onClick={this.onCloseModal}>Cancel</CButton>
                    </CModalFooter> */}
                  </CModal>
        ...
        <div className="d-flex align-items-center tableFooter">
          ...
          <div>
            <CFormGroup className="col-sm-12 mb-0 rowSelect">
              <CSelect custom name="select" id="select" className="custom-select">
