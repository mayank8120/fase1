        ...
        <>
            <main className="summary">
                <div class="backBlueColor">
                    <CRow className="statementBreadcrumb mb-24">
                    ...
                    <CRow>
                        <CCol md="6">
                            <CFormGroup className=" mb-0 primaryBlueColor">
                                <CSelect custom name="select" id="select" className="priceSelect price-Select">
                    ...
                    <CRow className="">
                        <CCol md="6" className="mt-3 dark-black">
                    ...
                    <CTabs activeTab="home">
                        ...
                        <CTabContent>
                            <CTabPane data-tab="home">
                                ...
                                <CRow className="mt-24 pl-15 pr-15">
