  ...
  return (
    <>
      <div class="backBlueColor">
        <CRow className="statementBreadcrumb">
          <CCol md="12" className="font-weight700 font-size24 dark-black">
            <Breadcrumb>
        ...
        <CRow className="">
          <CCol md="6" className="mt-4 dark-black">
        ...
        <CRow className="pt-3 pb-4">
          <CCol md="6" className="mt-2 dark-black">
            <div className="statementBox bg-white box-shadow brdrRadius8">
              <div class="d-flex align-items-center mb-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="44" height="44" viewBox="0 0 44 44" fill="none">
                  <circle opacity="0.1" cx="22" cy="22" r="22" fill="#FF9A32" />
      ...
      <CRow>
        <CCol className="mb-3 pl-0 pr-0">  <img className="w-100" src={require('../../../assets/img/graph6.png').default} alt="" /></CCol>

      </CRow>
      <CRow>

        <CCol className="mb-3 pl-0 pr-0">  <img className="w-100" src={require('../../../assets/img/graph7.png').default} alt="" /></CCol>

      </CRow>
      <CRow>

        <CCol className="mb-3 pl-0 pr-0">  <img className="w-100" src={require('../../../assets/img/graph8.png').default} alt="" /></CCol>
      </CRow>
