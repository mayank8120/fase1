      ...
      <tr key="main">
        ...
        <td className="pad-19-16">
          <div class="d-flex align-items-center editDeleteIcon">
            ...
            {/* <CButton onClick={console.log('jhscs')} variant="primary" className="colorblue font-size18 font-weight700 ml-auto">
            ...
            >
              ...
              <CModalBody>
                <CCol md="12">
                  ...
                  <CRow className="mt-4 borderbottommodal">

                    <CCol md="6">
                      <p className="d-flex align-items-center font-weight400 font-size16 primaryBlueColor">third  <CInput className="mr-3 ml-3 width60 height40" type="number" placeholder="3" />hour(s)</p>
                    ...
                    <CCol md="6">
                      ...
                      >$</span> <CInput className="mr-3 ml-3 text-center width60 height40" type="text" placeholder="2.00" />per hour</p>
                      <p className="d-flex align-items-center font-weight400 font-size16 primaryBlueColor">$ <CInput className="mr-3 ml-3 text-center width60 height40" type="text" placeholder="4.00" />per hour</p>
                    </CCol>
                  </CRow>
  ...
  render() {
    ...
    return (
      <main className="pricing-setting">
        <CRow className="pricingBreadcrumb">
          <CCol md="12 pl-0 pr-0" className="font-weight700 font-size24 primaryBlueColor">
            <Breadcrumb>
          ...
          <CCol md="6" className="pl-0">
            <div className="default-regular-hour">
              <div class="d-flex align-items-center">
                ...
                <CButton onClick={this.onClickButtonpeak} variant="primary" className="colorblue font-size18 font-weight700 ml-auto">
...
<CModalBody>
                    <CCol md="12">
                      ...
                      <CRow className="mt-4 borderbottommodal">
                        ...
                        <CCol md="6">
                          <p className="d-flex align-items-center font-weight400 font-size16 primaryBlueColor">First <CInput className="mr-3 ml-3 width60 height40" type="number" placeholder="3" />hour(s)</p>
                      ...
                      <CRow className="mt-4 opacity7 borderbottommodal">

                        <CCol md="6">
                          <p className="d-flex align-items-center font-weight400 font-size16 primaryBlueColor">First <CInput className="mr-3 ml-3 width60 height40" type="number" placeholder="3" />kWh</p>
                          <p className="d-flex align-items-center font-weight400 font-size16 primaryBlueColor">Thereafter</p>
                        </CCol>
                        <CCol md="6">
                          <p className="d-flex align-items-center font-weight400 font-size16 primaryBlueColor"><span
                          >$</span> <CInput className="mr-3 ml-3 text-cente width60 height40" type="text" placeholder="2.00" />per kWh</p>
                          <p className="d-flex align-items-center font-weight400 font-size16 primaryBlueColor">$ <CInput className="mr-3 ml-3 text-center width60 height40" type="text" placeholder="4.00" />per kWh</p>
                        </CCol>
                      </CRow>
                      <CRow className="mt-4 borderbottommodal">
                        ...
                        <CCol md="6">
                          <p className="d-flex align-items-center font-weight400 font-size16 primaryBlueColor justify-content-center"><CInput className="mr-3 ml-3 text-center width60 height40" type="text" placeholder="2.00" />%</p>
 ...
 */}
          ...
          <CCol md="6" className="responsivemt-1">
            <div className="default-regular-hour">
              <div class="d-flex align-items-center">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                ...
                <CButton onClick={this.onClickButtonregular} variant="primary" className="colorblue font-size18 font-weight700 ml-auto">
                  <span className="colorblue font-size18 font-weight700 ml-auto" > Edit</span>
                </CButton>{' '}
