          ...
          <CCol lg="12" className="pl-0 pr-0">
            <div className="d-flex align-items-center responsiveTable">
              ...
              <div class="ml-auto d-flex align-items-center ">
                ...
                <CButton onClick={this.onClickButton} variant="primary" className="mr-1 colorWhite gradientBtn font-size14 font-weight700 d-flex align-items-center">
                    ...
                    <div className="add-staff">
                      <CRow className="align-items-center justify-content-center">
                        ...
                        <CCol md="12" className="maxWidth">
                          ...
                          <CFormGroup className="col-sm-12 p-0 mb32">
                            <CLabel htmlFor="ccnumber" className="d-flex">Mobile Number </CLabel>
                            <CInput id="" placeholder="Password" />
                          </CFormGroup>
                          <CFormGroup className="col-sm-12  p-0">
                          <CLabel htmlFor="select">Roles</CLabel>
                          <CSelect className="price-select" name="select" id="select">
                ...
                <tr>
                  ...
                  <th className="pad-4-11">
                    <div className="rounderSearchBar posRel">
                      ...
                      <input class="form-control max-width-80" type="text" id="" />
                    </div>
                  </th>
                  <th className="pad-4-11">
                    <div className="rounderSearchBar posRel">
                      ...
                      <input class="form-control max-width-200" type="text" id="" />
                    </div>
                  </th>
                  <th className="pad-4-11">
                    <div className="rounderSearchBar posRel">
